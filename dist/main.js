...
const GITHUB_API_BASE_URL = stripTrailingSlash(process.env.GITHUB_API_BASE_URL || "https://api.github.com");
...
const GITHUB_BASE_URL = stripTrailingSlash(process.env.GITHUB_BASE_URL || "https://github.com");
